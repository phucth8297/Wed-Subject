		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 post-list">
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg='<c:url value="/resources/img/blog/1.jpg"/> '></div>
						<div class="post-content">
							<h3><a href="single-blog">Parents who try to be their children’s best friends</a></h3>
							<div class="post-meta">
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg='<c:url value="/resources/img/blog/2.jpg"/> '></div>
						<div class="post-content">
							<h3><a href="single-blog">Graduations could be delayed as external examiners</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg='<c:url value="/resources/img/blog/3.jpg"/> '></div>
						<div class="post-content">
							<h3><a href="single-blog">Private schools adopt a Ucas-style application system</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg='<c:url value="/resources/img/blog/4.jpg"/> '></div>
						<div class="post-content">
							<h3><a href="single-blog">Cambridge digs in at the top of university league table</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
